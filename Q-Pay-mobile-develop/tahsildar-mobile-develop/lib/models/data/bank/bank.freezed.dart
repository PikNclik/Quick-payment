...
class _$_Bank implements _Bank {
  const _$_Bank({this.id, this.createdAt, this.updatedAt, this.name});
  ...
  @override
  String toString() {
    return 'Bank(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, name: $name)';
  }
