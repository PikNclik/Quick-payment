...
TextTheme textTheme({bool darkMode = false}) {
  return TextTheme(
    ...
    bodyLarge: TextStyle(color: darkMode ? DesignColorsDark.textColor : DesignColors.textColor),
    bodyMedium: TextStyle(color: darkMode ? DesignColorsDark.textColor : DesignColors.textColor),
  );
}
