...
class Cropper extends StatefulWidget {
  ...
  /// The background color of the cropper widgets, visible when the image won't
  /// fill the entire widgets. Defaults to a light grey color: Color(0xFFCECECE).
  ...
  /// Crops the image as displayed in the cropper widgets, converts it to PNG format and returns it
  /// as [Uint8List]. The cropper widgets should be referenced using its key.
...
class _CropperState extends State<Cropper> {
  ...
  double _getCoverRatio(Size outside, Size inside) {
    return outside.width / outside.height > inside.width / inside.height ? outside.width / inside.width : outside.height / inside.height;
  }
...
class _OverlayFrame extends CustomClipper<Path> {
  ...
  @override
  bool shouldReclip(CustomClipper<Path> oldClipper) => aspectRatio != (oldClipper as _OverlayFrame).aspectRatio;
}
