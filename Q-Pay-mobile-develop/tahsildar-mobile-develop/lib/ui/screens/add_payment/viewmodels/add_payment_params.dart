...
class AddPaymentParams {
  ...
  final payerName = const FormzText.pure("").liveData;
   final paymentType = const FormzText.pure("").liveData;
   final paymentTypesList = ["normal","partial","follow-up"].liveData;
  ...
  isFormFilled() {
    return payerName.inputValue().isNotEmpty && payerMobile.value.valid && paymentAmount.inputValue().isNotEmpty;
  }
}
