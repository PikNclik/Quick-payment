...
class _UserRestClient implements UserRestClient {
  ...
  @override
  Future<BaseResponse<User>> getUser({cancelToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<BaseResponse<dynamic>> removeFcmToken({cancelToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<BaseResponse<List<City>>> getAddresses({
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BaseResponse<List<City>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
