...
class _SettingRestClient implements SettingRestClient {
  ...
  Future<BaseResponse<List<Setting>>> findAll({cancelToken}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<BaseResponse<List<Setting>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = BaseResponse<List<Setting>>.fromJson(
      _result.data!,
      (json) => (json as List<dynamic>).map<Setting>((i) => Setting.fromJson(i as Map<String, dynamic>)).toList(),
    );
    return value;
  }
  ...
  Future<BaseResponse<Setting>> findOne({
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<BaseResponse<Setting>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
